...
import com.`fun`.hairclipper.databinding.ActivityMachine10Binding

class Machine10 : BaseClass() {
    var vibrator: Vibrator? = null
    var mediaPlayer: MediaPlayer? = null
    private val binding by lazy { ActivityMachine10Binding.inflate(layoutInflater) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mediaPlayer = MediaPlayer.create(this@Machine10, R.raw.hair_clipper10)
    ...
    private fun loadBannerAd() {
        val adId = if (AdConstants.TEST_ADS) {
            ...
            RemoteConfig.getString(RemoteConfig.MACHINE10_BANNER_AD_ID)
        }
        val makeCollapsible = RemoteConfig.getBoolean(RemoteConfig.MACHINE10_BANNER_MAKE_COLLAPSIBLE)
        val enable = RemoteConfig.getBoolean(RemoteConfig.ENABLE_MACHINE10_BANNER_AD)
