...
class Machine11 : BaseClass() {
    ...
    private fun loadBannerAd() {
        val adId = if (AdConstants.TEST_ADS) {
            ...
            RemoteConfig.getString(RemoteConfig.MACHINE11_BANNER_AD_ID)
        }
        val makeCollapsible =
            RemoteConfig.getBoolean(RemoteConfig.MACHINE11_BANNER_MAKE_COLLAPSIBLE)
        val enable = RemoteConfig.getBoolean(RemoteConfig.ENABLE_MACHINE11_BANNER_AD)
