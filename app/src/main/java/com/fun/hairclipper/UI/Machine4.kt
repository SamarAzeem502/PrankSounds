...
import com.`fun`.hairclipper.databinding.ActivityMachine4Binding

class Machine4 : BaseClass() {
    var vibrator: Vibrator? = null
    var mediaPlayer: MediaPlayer? = null
    private val binding by lazy { ActivityMachine4Binding.inflate(layoutInflater) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mediaPlayer = MediaPlayer.create(this@Machine4, R.raw.hair_clipper4)
    ...
    private fun loadBannerAd() {
        val adId = if (AdConstants.TEST_ADS) {
            ...
            RemoteConfig.getString(RemoteConfig.MACHINE4_BANNER_AD_ID)
        }
        val makeCollapsible = RemoteConfig.getBoolean(RemoteConfig.MACHINE4_BANNER_MAKE_COLLAPSIBLE)
        val enable = RemoteConfig.getBoolean(RemoteConfig.ENABLE_MACHINE4_BANNER_AD)
