...
public class machine10 extends BaseClass {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_machine10);
        ...
        ImageView imageView = findViewById(R.id.home_btn);
        imageView.setOnClickListener(v -> finish());
        mediaPlayer = MediaPlayer.create(machine10.this, R.raw.hair_clipper10);
