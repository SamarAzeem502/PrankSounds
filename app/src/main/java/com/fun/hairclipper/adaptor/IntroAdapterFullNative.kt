        ...
        if (item is Int) {
            ...
            when (item) {
                1 -> {
                    ...
                    Glide.with(binding.root).load(R.drawable.fart1).into(binding.ivHowToDownload)
                    ...
                    setDots(0, ArrayList(listOf(binding.ivDot1, binding.ivDot2)))
                ...
                2 -> {
                    binding.tvTitle.text = ""
                    binding.tvPageDetail.text = ""
                    Glide.with(binding.root).load(R.drawable.fart2).into(binding.ivHowToDownload)
                    ...
                    setDots(1, ArrayList(listOf(binding.ivDot1, binding.ivDot2)))
