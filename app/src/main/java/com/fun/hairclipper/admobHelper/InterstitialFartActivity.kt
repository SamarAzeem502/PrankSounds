...
object InterstitialFartActivity {
    private var interstitialAdRequesting = false
    private var interstitialAd: InterstitialAd? = null

    fun loadInterstitialAdFart(
        mContext: Context,
        adUnitId: String,
        ...
        if (interstitialAdRequesting ||
            ...
            !RemoteConfig.getBoolean(RemoteConfig.ENABLE_FART_INTERSTITIAL_AD)

        ) {
            Log.d("loading...", "InterstitialFartActivity: $interstitialAdRequesting")
            Log.d("loading...", "InterstitialFartActivity: ${internetConnection(mContext).not()}")
            Log.d("loading...", "InterstitialFartActivity: ${interstitialAd != null}")
            Log.d(
                "loading...",
                "InterstitialFartActivity: ${!RemoteConfig.getBoolean(RemoteConfig.ENABLE_FART_INTERSTITIAL_AD)}"
            )
            return
        }
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(p0: LoadAdError) {
                    ...
                    Log.d(
                        "loading...",
                        "InterstitialFartActivity_failed" + p0.responseInfo?.responseId
                    )
                }
                ...
                override fun onAdLoaded(p0: InterstitialAd) {
                    ...
                    Log.d("loading...", "InterstitialFartActivity_loaded")
                }
            })
    }

    fun showInterstitialAdFart(activity: Activity, callback: FullScreenAdListener? = null) {
