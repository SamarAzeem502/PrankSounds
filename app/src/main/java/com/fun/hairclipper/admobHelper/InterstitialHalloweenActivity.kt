...
object InterstitialHalloweenActivity {
    private var interstitialAdRequesting = false
    private var interstitialAd: InterstitialAd? = null

    fun loadInterstitialAdHalloween(
        mContext: Context,
        adUnitId: String,
        ...
        if (interstitialAdRequesting ||
            ...
            !RemoteConfig.getBoolean(RemoteConfig.ENABLE_HALLOWEEN_INTERSTITIAL_AD)

        ) {
            Log.d("loading...", "InterstitialHalloweenActivity: $interstitialAdRequesting")
            Log.d("loading...", "InterstitialHalloweenActivity: ${internetConnection(mContext).not()}")
            Log.d("loading...", "InterstitialHalloweenActivity: ${interstitialAd != null}")
            Log.d(
                "loading...",
                "InterstitialHalloweenActivity: ${!RemoteConfig.getBoolean(RemoteConfig.ENABLE_HALLOWEEN_INTERSTITIAL_AD)}"
            )
            return
        }
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(p0: LoadAdError) {
                    ...
                    Log.d(
                        "loading...",
                        "InterstitialHalloweenActivity_failed" + p0.responseInfo?.responseId
                    )
                }
                ...
                override fun onAdLoaded(p0: InterstitialAd) {
                    ...
                    Log.d("loading...", "InterstitialHalloweenActivity_loaded")
                }
            })
    }

    fun showInterstitialAdHalloween(activity: Activity, callback: FullScreenAdListener? = null) {
