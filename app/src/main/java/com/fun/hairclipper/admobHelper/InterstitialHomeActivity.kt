...
object InterstitialHomeActivity {
    private var interstitialAdRequesting = false
    private var interstitialAd: InterstitialAd? = null

    fun loadInterstitialAdHome(
        mContext: Context,
        adUnitId: String,
        ...
        if (interstitialAdRequesting ||
            ...
            !RemoteConfig.getBoolean(RemoteConfig.ENABLE_HOME_INTERSTITIAL_AD)

        ) {
            Log.d("loading...", "InterstitialHomeActivity: $interstitialAdRequesting")
            Log.d("loading...", "InterstitialHomeActivity: ${internetConnection(mContext).not()}")
            Log.d("loading...", "InterstitialHomeActivity: ${interstitialAd != null}")
            Log.d(
                "loading...",
                "InterstitialHomeActivity: ${!RemoteConfig.getBoolean(RemoteConfig.ENABLE_HOME_INTERSTITIAL_AD)}"
            )
            return
        }
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(p0: LoadAdError) {
                    ...
                    Log.d(
                        "loading...",
                        "InterstitialHomeActivity_failed" + p0.responseInfo?.responseId
                    )
                }
                ...
                override fun onAdLoaded(p0: InterstitialAd) {
                    ...
                    Log.d("loading...", "InterstitialHomeActivity_loaded")
                }
            })
    }

    fun showInterstitialAdHome(activity: Activity, callback: FullScreenAdListener? = null) {
