...
object InterstitialTrimmerActivity {
    private var interstitialAdRequesting = false
    private var interstitialAd: InterstitialAd? = null

    fun loadInterstitialAdTrimmer(
        mContext: Context,
        adUnitId: String,
        ...
        if (interstitialAdRequesting ||
            ...
            !RemoteConfig.getBoolean(RemoteConfig.ENABLE_TRIMMER_INTERSTITIAL_AD)

        ) {
            Log.d("loading...", "InterstitialTrimmerActivity: $interstitialAdRequesting")
            Log.d("loading...", "InterstitialTrimmerActivity: ${internetConnection(mContext).not()}")
            Log.d("loading...", "InterstitialTrimmerActivity: ${interstitialAd != null}")
            Log.d(
                "loading...",
                "InterstitialTrimmerActivity: ${!RemoteConfig.getBoolean(RemoteConfig.ENABLE_TRIMMER_INTERSTITIAL_AD)}"
            )
            return
        }
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(p0: LoadAdError) {
                    ...
                    Log.d(
                        "loading...",
                        "InterstitialTrimmerActivity_failed" + p0.responseInfo?.responseId
                    )
                }
                ...
                override fun onAdLoaded(p0: InterstitialAd) {
                    ...
                    Log.d("loading...", "InterstitialTrimmerActivity_loaded")
                }
            })
    }

    fun showInterstitialAdTrimmer(activity: Activity, callback: FullScreenAdListener? = null) {
