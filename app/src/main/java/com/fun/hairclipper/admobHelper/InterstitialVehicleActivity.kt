...
object InterstitialVehicleActivity {
    private var interstitialAdRequesting = false
    private var interstitialAd: InterstitialAd? = null

    fun loadInterstitialAdVehicle(
        mContext: Context,
        adUnitId: String,
        ...
        if (interstitialAdRequesting ||
            ...
            !RemoteConfig.getBoolean(RemoteConfig.ENABLE_VEHICLE_INTERSTITIAL_AD)

        ) {
            Log.d("loading...", "InterstitialVehicleActivity: $interstitialAdRequesting")
            Log.d("loading...", "InterstitialVehicleActivity: ${internetConnection(mContext).not()}")
            Log.d("loading...", "InterstitialVehicleActivity: ${interstitialAd != null}")
            Log.d(
                "loading...",
                "InterstitialVehicleActivity: ${!RemoteConfig.getBoolean(RemoteConfig.ENABLE_VEHICLE_INTERSTITIAL_AD)}"
            )
            return
        }
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(p0: LoadAdError) {
                    ...
                    Log.d(
                        "loading...",
                        "InterstitialVehicleActivity_failed" + p0.responseInfo?.responseId
                    )
                }
                ...
                override fun onAdLoaded(p0: InterstitialAd) {
                    ...
                    Log.d("loading...", "InterstitialVehicleActivity_loaded")
                }
            })
    }

    fun showInterstitialAdVehicle(activity: Activity, callback: FullScreenAdListener? = null) {
